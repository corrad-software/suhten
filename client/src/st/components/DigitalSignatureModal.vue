...
<template>
  <div v-if="open" class="fixed inset-0 z-[90] flex items-center justify-center bg-slate-900/40 px-4 backdrop-blur-sm">
    <div class="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-800">
      ...
      <p class="mt-2 text-[11px] text-slate-400 dark:text-slate-500">PIN demo: <span class="font-mono">{{ DEMO_SIGNATURE_PIN }}</span></p>
