            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #e3e8ee;border-radius:8px;">
                <tr>
                    <td style="padding:28px 28px 8px;">
                        ...
                        <h1 style="margin:0 0 12px;font-size:20px;line-height:1.3;">Permohonan ditolak</h1>
                        <p style="margin:0 0 20px;font-size:14px;line-height:1.5;color:#3c4257;">
                            Permohonan anda telah ditolak. Sila semak catatan pegawai di bawah untuk maklumat lanjut.
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding:0 28px 20px;">
                        <p style="margin:0 0 8px;font-size:13px;font-weight:600;color:#697386;text-transform:uppercase;letter-spacing:0.04em;">Sebab penolakan</p>
                        <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:6px;padding:14px 16px;font-size:14px;line-height:1.6;color:#3c4257;white-space:pre-wrap;">{{ $note }}</div>
                    </td>
                </tr>
                <tr>
